...
public class TarUtils {
	...
	public static void archive(File srcFile, File destFile) throws Exception {
         ...
         * @throws Exception
         */
        public static void archiveFiles(List<File> srcFileList, File destFile) throws Exception {
	...
	private static void fileProber(File dirFile) {
        ...
        public static void archive() throws Exception{
            ...
            File f2 = new File("c:/test/b.txt");
            File t = new File("c:/t/x.tar");
            List<File> fileList = new ArrayList<File>();
            fileList.add(f1);
            fileList.add(f2);
            TarUtils.archiveFiles(fileList,t);
         //   TarUtils.dearchive(path + ".tar", "d:/fds");
        }

        public static void deArchive() throws Exception{
            File t = new File("c:/t/x.tar");
            TarUtils.dearchive(t, new File("c:/2015"));
        }
