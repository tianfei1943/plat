...
<body id="minwidth-body">
	<div id="border-top" class="h_blue">
		<span class="logo" style="display: none"><a href="http://www.joomla.org" target="_blank"><img src="templates/<?php echo  $this->template ?>/images/logo.png" alt="Joomla!" /></a></span>
